...
pygame.display.set_caption('mario_cats')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('mario_cats.png')
...
def game_over():
    ...
    game_over_img = pygame.image.load('mario_game_over.png')
...
def start_game():
    canvas.fill(BLACK)
    start_img = pygame.image.load('mario_start.png')
